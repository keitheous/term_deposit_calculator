...
RSpec.describe TermDepositCalculator::CLI do
  ...
  let(:fake_calculator_class) do
    Class.new do
      ...
      def calculate_interest_paid_at_maturity = '330.00'
      def calculate_interest_paid_per_year = '110.00'
      def calculate_interest_paid_per_quarter = '110.00'
      def calculate_interest_paid_per_month = '110.00'
    end
  end
